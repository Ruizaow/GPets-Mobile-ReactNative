      ...
      <>
        ...
        <View style={styles.content}>
          <View style={styles.textArea}>
            <Text style={[fontStyles.title_2, { color: colors.beige }]}>Nova senha</Text>
            <Text style={styles.description}>
              Crie uma senha forte e segura para proteger {'\n'}a sua conta no GPets e finalizar o processo 
            </Text>
          </View>
  ...
  function Step2() {
    return (
      <View style={styles.contentFinal}>
        ...
        <View style={styles.textArea}>
          <Text style={[fontStyles.title_2, { color: colors.beige }]}>Senha alterada</Text>
